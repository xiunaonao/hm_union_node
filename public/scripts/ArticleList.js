...
//         ul += '<li tid="' + dat[i].NTCID + '"><h4>' + dat[i].ROWIDATE + '</h4>';
//         if (dat[i].CoverUrl) {
//             var imgUL = dat[i].CoverUrl.split(',');
//             if (imgUL.length >= 3) {
//                 ul += '<p><a href="PhoneDetail?id=' + dat[i].NTCID + '&nick=' + dat[i].Author + '" style="text-decoration: none;color: inherit;">' + div.innerText + '</a></p>';
//                 ul += '<p style="height:2.3rem;"><a href="PhoneDetail?id=' + dat[i].NTCID + '&nick=' + dat[i].Author + '" style="text-decoration: none;color: inherit;"><img src="' + imgUL[0] + '"/><img src="' + imgUL[1] + '"/><img src="' + imgUL[2] + '"/></a></p>';
//             } else if (imgUL.length >=1) {
//                 ul += '<p  style="height:2rem;"><a href="PhoneDetail?id=' + dat[i].NTCID + '&nick=' + dat[i].Author + '" style="text-decoration: none;color: inherit;"><img style="float:left;" src="' + imgUL[0] + '"/><span style="float:left;">' + div.innerText + '</span></a></p>';
//             }
//         } else {
//             ul += '<p><a href="PhoneDetail?id=' + dat[i].NTCID + '&nick=' + dat[i].Author + '" style="text-decoration: none;color: inherit;">' + div.innerText + '</a></p>';
//         }
...
//         ul += '<h3><a href="PhoneEditor?id=' + dat[i].NTCID + '&nick=' + dat[i].Author + '&memberId='+memberId+'" class="article-editor">编辑</a> <a class="article-delete">删除</a></h3></li>';
//     }
